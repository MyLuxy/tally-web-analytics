...
// A bare preview of the traffic trend for the compact "Traffic" card -- no
// axis, grid, legend or tooltip (that's what the expanded full <Chart> is
// for). preserveAspectRatio="none" so it stretches to whatever box the card
// gives it instead of letterboxing.
