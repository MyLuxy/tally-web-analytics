...
// (that's what the expanded view's full <Chart> is for). A real, gentle
// aspect ratio -- CSS scales it down to fit without distorting it into a
// flat smear the way preserveAspectRatio="none" used to.
